...
function et_get_comments_popup_link( $zero = false, $one = false, $more = false ) {
	...
	return '<span class="comments-number">' . '<a href="' . esc_url( get_permalink() . '#disqus_thread' ) . '">' . apply_filters('dsq_comments_text', $output, $number) . '</a>' . '</span>';
}
endif;*/
